...
function setChat()
    {
        const chatbotButton = document.querySelector('.chatbot')
        const chatbotContainer = document.querySelector('.botui-container')
        let isActive = false

        chatbotButton.addEventListener('click', () => 
        {
            if(isActive == false){
                chatbotContainer.style.transform ='translateY(500px)'
                isActive = true
            } else {
                chatbotContainer.style.transform ='translateY(-500px)'
                isActive = false
